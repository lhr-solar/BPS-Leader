...
test:
ifdef TEST
	$(MAKE) -C Embedded-Sharepoint -C BSP -C STM32F413 TARGET=bps-leader PROJECT_DIR=../../.. BUILD_DIR=../../../Objects TEST=../../../Tests/Test_$(test).c PROJECT_C_SOURCES=../../../Drivers/Src/*.c PROJECT_C_SOURCES=../../../Drivers/Src/*.c
else
