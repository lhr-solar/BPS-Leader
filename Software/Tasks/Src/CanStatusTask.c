...
static uint32_t get_avg_temp() {
    ...
    return (iint32_t)(temp_sum / NUM_BATTERY_MODULES);
}
...
void Task_Can_Status() {
    ...
    while (true) {
        ...
        // PLACEHOLDER
            ...
            }tus = get_segment_status(6);
        bps_status_message.BPS_Segment7_Sta
            else {
        ...
        bps_status_message.BPS_Segment6_Status = get_segment_status(7);
