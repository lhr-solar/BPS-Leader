...
#define CAN_ID_CHARGER_INTERFACE_STATUS  0x0E
...
#define CAN_DLC_CONTROLS_STATUS 1
...
#define CAN_DLC_CHARGER_INTERFACE_STATUS 5
...
typedef enum {
    CONTROLS_STATUS_CONTROLS_LEADER_FAULT_LIGHTING_FAULT = 4,
...
typedef enum {
    ...
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED_1 = 14,
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED_2 = 13,
    ...
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED_3 = 7,
...
typedef enum {
    ...
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED_1 = 14,
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED_2 = 13,
    ...
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED_3 = 7,
...
typedef enum {
    ...
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED_1 = 14,
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED_2 = 13,
    ...
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED_3 = 7,
