...
typedef enum {
    ...
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 14,
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED2 = 13,
    ...
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED3 = 7,
...
typedef enum {
    ...
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED4 = 14,
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED5 = 13,
    ...
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED6 = 7,
...
typedef enum {
    ...
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED6 = 14,
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED7 = 13,
    ...
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED8 = 7,
