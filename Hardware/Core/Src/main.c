...
static void MX_I2C4_SMBUS_Init(void)
{
  ...
  hsmbus4.Init.Timing = 0x10D19CE4;
  ...
  hsmbus4.Init.SMBusTimeout = 0x000083D0;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_12, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC2 PC10 PC12 */
